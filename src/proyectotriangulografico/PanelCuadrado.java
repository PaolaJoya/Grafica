...
public class PanelCuadrado extends JPanel{
     ...
     * @param principal
     */
    public PanelCuadrado(PrincipalCuadrado principal) {
    ...
    protected void paintComponent(Graphics g){
        ...
        polygon.addPoint((this.getWidth()/2)+(int) puntoD.getX(),(this.getHeight()/2)-(int) puntoD.getY());
     ...
     * @param puntoD
     */
    public void setPuntoD(ObtienePunto puntoD) {
        this.puntoD = puntoD;
    }
